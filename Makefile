...
OFILES = gba.o font.o main.o images/background.o images/tile.o images/start.o images/info.o images/knight.o images/tile_2.o images/green.o images/red.o images/bomb.o images/key.o images/door_locked.o images/door_unlocked.o images/door_open.o images/win.o images/lose.o
